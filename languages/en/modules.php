 ...
 * Front end modules
 */
$GLOBALS['TL_LANG']['FMD']['euf_overlay'] = array('EuF-Overlay', 'Creates an overlay that covers the whole page.');

/**
 * Legends
 */
$GLOBALS['TL_LANG']['tl_module']['overlay_richtext_legend'] = "Overlay-Content: Richtext";
$GLOBALS['TL_LANG']['tl_module']['overlay_html_legend'] = "Overlay-Content: HTML";
$GLOBALS['TL_LANG']['tl_module']['overlay_settings_legend'] = "Overlay-Settings";

/**
 * Fields
 */
$GLOBALS['TL_LANG']['tl_module']['overlay_richtext'] = array('Richtext-Content','Add your message and style it via TinyMCE here.');
